 ...
 */
public class GetLastOnlineInfoGuild extends AsyncTask<String, Void, String> {

    Exception except = null;
    TextView result;
    String uuidValue;

    public GetLastOnlineInfoGuild(TextView playerLastOnline){
    ...
    protected void onPostExecute(String json){
        String resultString = "";
        Log.i("LASTONLINE-GUILD", "Last Online Data received for " + uuidValue + ". Parsing...");
        if (except != null){
