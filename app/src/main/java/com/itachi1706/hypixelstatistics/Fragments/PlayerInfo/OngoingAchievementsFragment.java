 ...
 */
public class OngoingAchievementsFragment extends BaseFragmentCompat {

    public OngoingAchievementsFragment() {
    }
    ...
    public void processPlayerJson(String json){
        Log.i("HypixelStatistics", "Switched to OngoingAchievementFragments");
